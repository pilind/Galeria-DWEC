...
let author1 = new Author('Carlitos', 'pepito1@gallery.com');
let author2 = new Author('Felipito', 'manolito1@gallery.com');
let author3 = new Author('Ramoncito', 'antoñito1@gallery.com');
let author4 = new Author('Ricardito', 'miguelito1@gallery.com');
let author5 = new Author('Alfredito', 'ramoncito@gallery.com');
