...
class GalleryView {
	...
	showAdminMenu() {
		...
		let container = $(`<div class="dropdown-menu" aria-labelledby="navAdmin">
			...
			<a id="lnewProduct" class="dropdown-item" href="#new-category">Crear imagen</a>
			...
			let modal = $(`<div class="modal fade" id="removeProductModal" tabindex="-1"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							La imagen <strong>${image.title} - ${image.author}</strong> ha sido eliminado correctamente.
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-primary" data-dismiss="modal">Aceptar</button>
						</div>
	...
	bindAdminMenu(hNewCategory, hRemoveCategory, hNewProduct, hRemoveProduct, hNewAuthor, hRemoveAuthor) {
